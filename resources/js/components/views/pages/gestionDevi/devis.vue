...
import debounce from 'lodash/debounce'
    ...
    const getDevis = async(page = 1, perPage = 5)=>{
                            ...
                            <div class="flex items-center gap-2">
                              <div class="flex items-center gap-[.5625rem]">
                                ...
                                <div><a href="invoice-preview.html">
                                    <h4 class="text-xs font-semibold text-white">{{ devi.id }}</h4></a></div>
                              </div>
                            </div>
                          </td>
                         
                          <td class="min-w-[7.5rem]">
                            <h4 class="text-xs font-semibold text-white">{{ devi.client.nom }}</h4>
                          </td>
                          <td class="min-w-[7.5rem]">
                            <h4 class="text-xs font-semibold text-white">{{ devi.created_at }}</h4>
                          </td>
                          <td class="min-w-[7.5rem]">
                            <h4 class="text-xs font-semibold text-white">{{ devi.total }} F.CFA</h4>
                          </td>
