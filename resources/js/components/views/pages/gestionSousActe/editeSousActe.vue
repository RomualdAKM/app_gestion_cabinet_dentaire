              ...
              <div class="card tabs" style="background-color: rgb(163, 23, 165);">
                <div class="card-header pb-2 header-bottom-border">
                  <div class="flex flex-col">
                    <h2 class="text-lg font-bold text-warning">MODIFIER SOUS_ACTE</h2>
                    ...
                    <div class="tab-pan active show " data-tabContent="1">
                      <div class="checkout-detail">    
                        <form class="theme-form flex flex-col gap-4 !m-0" style="background-color: rgb(163, 23, 165);">
                            ...
                            <div> 
                                <label for="productName" style="color: rgb(240, 198, 92); font-weight: 900;">Nom</label>
                                <input type="text" v-model="code.nom"  id="productName" placeholder="Nom">
                            </div>
                            <div>
                                <label for="productName" style="color: rgb(240, 198, 92); font-weight: 900;">Prix</label>
                                <input type="text" v-model="code.prix"  id="productName" placeholder="Prix">
                            </div>
                            <div class="col-span-3  md:col-span-6 sm:col-span-12 min-w-[150px]">
                            <label for="number" style="color: rgb(240, 198, 92); font-weight: 900;">Acte</label> 
